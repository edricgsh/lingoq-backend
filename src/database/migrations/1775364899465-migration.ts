...
export class Migration1775364899465 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lingoq"."learning_sessions" ADD "proficiency_level" "lingoq"."learning_sessions_proficiency_level_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "lingoq"."learning_sessions" DROP COLUMN "proficiency_level"`);
