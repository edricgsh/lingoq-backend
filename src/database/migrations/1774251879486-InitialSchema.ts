...
export class Migration1774251879486 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "homework_questions" ADD CONSTRAINT "FK_ff4a2b6c5385919e26f4d452708" FOREIGN KEY ("homework_id") REFERENCES "homework"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "homework_answers" ADD CONSTRAINT "FK_9a6d8f81d125db85f2f6d5be461" FOREIGN KEY ("submission_id") REFERENCES "homework_submissions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_onboarding" ADD CONSTRAINT "FK_c604dd5a66a24d79b1ec42f4e57" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "learning_sessions" ADD CONSTRAINT "FK_6fdfb313bf6af9d4f7084a93ab1" FOREIGN KEY ("video_content_id") REFERENCES "video_content"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "homework_submissions" ADD CONSTRAINT "FK_f53e5ae262ff2280a092dff54bb" FOREIGN KEY ("homework_id") REFERENCES "homework"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "homework_submissions" ADD CONSTRAINT "FK_d11d40978349d11e718258242b9" FOREIGN KEY ("user_session_id") REFERENCES "learning_sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "flashcard_progress" ADD CONSTRAINT "FK_29a3733d0a9963ad1452b5015a2" FOREIGN KEY ("vocab_item_id") REFERENCES "vocab_items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "flashcard_progress" DROP CONSTRAINT "FK_29a3733d0a9963ad1452b5015a2"`);
        await queryRunner.query(`ALTER TABLE "homework" DROP CONSTRAINT "FK_cb341c634d004b3df210b0cf009"`);
        await queryRunner.query(`ALTER TABLE "homework_submissions" DROP CONSTRAINT "FK_d11d40978349d11e718258242b9"`);
        await queryRunner.query(`ALTER TABLE "homework_submissions" DROP CONSTRAINT "FK_f53e5ae262ff2280a092dff54bb"`);
        await queryRunner.query(`ALTER TABLE "learning_sessions" DROP CONSTRAINT "FK_6fdfb313bf6af9d4f7084a93ab1"`);
        await queryRunner.query(`ALTER TABLE "learning_sessions" DROP CONSTRAINT "FK_cc362342ca274ef516059737a74"`);
        await queryRunner.query(`ALTER TABLE "user_onboarding" DROP CONSTRAINT "FK_c604dd5a66a24d79b1ec42f4e57"`);
        await queryRunner.query(`ALTER TABLE "homework_answers" DROP CONSTRAINT "FK_9a6d8f81d125db85f2f6d5be461"`);
        await queryRunner.query(`ALTER TABLE "homework_questions" DROP CONSTRAINT "FK_ff4a2b6c5385919e26f4d452708"`);
        ...
        await queryRunner.query(`DROP TABLE "flashcard_settings"`);
        await queryRunner.query(`DROP INDEX "lingoq"."IDX_7c48e7329ed12a1c6d30c1b006"`);
        await queryRunner.query(`DROP TABLE "subtitle_cache"`);
        await queryRunner.query(`DROP TABLE "video_content"`);
        ...
        await queryRunner.query(`DROP TABLE "homework_answers"`);
        await queryRunner.query(`DROP TABLE "homework_questions"`);
        ...
        await queryRunner.query(`DROP TABLE "vocab_items"`);
    }
